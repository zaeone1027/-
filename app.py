...
st.set_page_config(page_title="생활관 종합 결산", page_icon="📱")import streamlit as st
import pandas as pd
import sqlite3
import time
from datetime import datetime, timedelta
